  ...
  data() {
    return {
      ...
      sampleInfo: [
        ...
        {title:'Formula', img:require('../assets/formula.png'), label:'포뮬러 기능', level:'고급기능', class:'primary'},
        {title:'Form', img:require('../assets/form.png'), label:'Form 형태를 이용한 상세보기', level:'실무예제', class:'deep-orange'},
        {title:'Multiple', img:require('../assets/multi.png'), label:'여러 개의 시트', level:'실무예제', class:'deep-orange'},
        {title:'Dialog', img:require('../assets/dialog.png'), label:'시트 + 다이얼로그', level:'실무예제', class:'deep-orange'},
      ]
    }
  }
}
